...
export function Hero(){
  ...
  return <MotionSurface className="reference-hero">
    <div className="ref-copy"><span className="ref-eyebrow">REAL IDEAS. REAL CONNECTIONS.<br/>A MORE OPEN FINANCIAL SYSTEM.</span><span className="ref-copy-rule"/><h1>Every market<br/>starts with<br/><em>a reason.</em></h1><p>Discover the thesis. Hold the coin.<br/>Earn the stocks.</p><div className="ref-actions"><Link href="/vaults" className="lk-button primary">Explore the thesis gallery <ArrowRight size={18}/></Link><Link href="/launch" className="lk-button quiet">Create your thesis <ArrowRight size={18}/></Link></div><div className="ref-facts"><div><b>One coin.</b><span>YOUR CONVICTION</span></div><div><b>Real stocks.</b><span>AS REWARDS</span></div><div><b>On Solana.</b><span>BUILT TO CONNECT</span></div></div><ContractAddress/></div>
