...
export function Hero(){
 ...
 return <MotionSurface className="lk-hero"><div className="hero-copy"><span className="eyebrow"><i className="blue-dot"/> CONNECT THE IDEA. OWN THE POSSIBILITY.</span><h1>Every market<br/>starts with<br/><em>a reason.</em></h1><p>Discover the thesis.<br/>Hold the coin. <span>Earn the stocks.</span></p><div className="hero-actions"><Link href="/launch" className="lk-button primary">Launch your LINKR <ArrowRight size={18}/></Link><Link href="/vaults" className="lk-button quiet">Explore markets <ArrowUpRight size={17}/></Link></div><div className="hero-footnote"><span className="tiny-links"><i/><i/></span><span>Trading fees become tokenised stocks.<br/>Distributed to the people who hold.</span></div></div>
